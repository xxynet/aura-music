...
export const HouseIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625A1.875 1.875 0 0 1 3.75 19.775v-6.198c.03-.028.06-.056.091-.086L12 5.432Z"
      clipRule="evenodd"
    />
  </svg>
);
